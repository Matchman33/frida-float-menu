...
sw.on('valueChanged', (value: boolean) => {
    console.log('Switch changed to:', value);
});
menu.addComponent('sw', sw);

const txt = new Text('myText', 'Hello World');
menu.addComponent('txt', txt);

const selector = new Selector('mySelector', ['Option 1', 'Option 2', 'Option 3'], 0);
