...
var FloatMenu = class {
  ...
  createMenuContainerWindow() {
    ...
    this.scrollView.setBackgroundColor(4283782485 | 0);
  ...
  createTabView(context) {
    try {
      ...
      scrollView.setBackgroundColor(4281545523 | 0);
  ...
  createHeaderView(context) {
    try {
      let createRadiusBtn2 = function(text, bgColor, textColor) {
        ...
        drawable2.setColor(bgColor);
        button.setBackgroundDrawable(drawable2);
        return button;
      };
      var createRadiusBtn = createRadiusBtn2;
      const LinearLayout = API.LinearLayout;
      const LinearLayoutParams = API.LinearLayoutParams;
      const TextView = API.TextView;
      ...
      drawable.setColor(4283782485 | 0);
      titleView.setBackgroundDrawable(drawable);
      const titleParams = LinearLayoutParams.$new(0, LinearLayoutParams.WRAP_CONTENT.value, 1);
      titleParams.setMargins(40, 8, 40, 8);
      titleView.setLayoutParams(titleParams);
      const hideButton = createRadiusBtn2("\u9690\u85CF", 4283782485 | 0, 4294967295 | 0);
